<!DOCTYPE html>
	<!--[if IE 8]>
		<html xmlns="http://www.w3.org/1999/xhtml" class="ie8" lang="en" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://ogp.me/ns/fb#">
	<![endif]-->
	<!--[if !(IE 8) ]><!-->
	...
	<title>Log In &lsaquo; McGill Engineering Investment Group &#8212; WordPress</title>
...
<link rel='stylesheet' id='login-css'  href='/wp-admin/css/login.min.css?ver=5.2.4' type='text/css' media='all' />
	...
	<link rel="icon" href="/wp-content/uploads/2019/02/log1.png" sizes="32x32" />
<link rel="icon" href="/wp-content/uploads/2019/02/log1.png" sizes="192x192" />
<link rel="apple-touch-icon-precomposed" href="/wp-content/uploads/2019/02/log1.png" />
<meta name="msapplication-TileImage" content="http://www.mcgilleig.com/wp-content/uploads/2019/02/log1.png" />
	</head>
	...
	<p class="submit">
		<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In" />
				<input type="hidden" name="redirect_to" value="http://www.mcgilleig.com/wp-admin/" />
	...
	d.select();
		...
		&larr; Back to McGill Engineering Investment Group	</a></p>
